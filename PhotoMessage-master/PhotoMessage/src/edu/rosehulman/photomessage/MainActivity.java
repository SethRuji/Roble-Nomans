...
public class MainActivity extends Activity implements OnClickListener {
	...
	private static final int SOON_NOTIFICATION_ID = 14;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == MainActivity.PICK_FROM_GALLERY_REQUEST) {
			...
			Bitmap tempBitmap = BitmapFactory.decodeFile(realPath);
			float height= tempBitmap.getHeight();
			float width= tempBitmap.getWidth();
			float aspect= height/width;			
			int containerWidth = mImageView.getWidth();
			mBitmap= Bitmap.createScaledBitmap(tempBitmap, mImageView.getWidth(),(int)(containerWidth*aspect) , false);
			mImageView.setImageBitmap(mBitmap);
	...
	private void notifyNow() {
		...
		// DONE: Replace this with a notification.
//		startActivity(displayIntent);
	...
	private Notification getNotification(Intent intent) {
		...
		int requestCodeunused= 0;
		PendingIntent pendingIntent = PendingIntent.getActivity(this, requestCodeunused, intent, PendingIntent.FLAG_UPDATE_CURRENT);
	...
	public void setSoonAlarm() {
		...
		// DONE: Replace this with a notification that launches via a timer.
//		startActivity(displayIntent);
		Notification notification = getNotification(displayIntent);
		...
		int requestCodeunused= 0;		
		PendingIntent pendingIntent = PendingIntent.getBroadcast(this,requestCodeunused , notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
