...
public class ScoreDataAdapter {
	...
	public Score getScore(long id) {
	 	...
	 	Cursor c = mDatabase.query(TABLE_NAME, projection, selection,
	...
	private static class ScoreDbHelper extends SQLiteOpenHelper{
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			Log.d(ScoresListActivity.SLS, "Updating from version " + oldVersion + " to " + newVersion + ", which will destroy old table(s).");
