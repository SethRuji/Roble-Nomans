 ...
 */
public class AttackExpandableListItem implements OnSizeChangedListener  {
	...
	public AttackExpandableListItem(String username, double distance, int cost) {
		mTitle = username;
        mImgResource = R.drawable.knight;
        mCollapsedHeight =150;
        mIsExpanded = false;
        mText = String.format("Distance: %.2f Cost: %d wheat" , distance, cost);
        this.cost=cost;
        mDistance= distance;
        mExpandedHeight = -1;        
	}
