...
package com.appspot.roble_nomans_debiruji.users;
...
public class Users extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.19.1 of the users library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://roble-nomans-debiruji.appspot.com/_ah/api/";
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "users/v1/user/";
  ...
  public class User {
    ...
    public class Delete extends UsersRequest<com.appspot.roble_nomans_debiruji.users.model.User> {
      ...
      protected Delete(java.lang.String entityKey) {
        super(Users.this, "DELETE", REST_PATH, null, com.appspot.roble_nomans_debiruji.users.model.User.class);
     ...
     *
     * @param content the {@link com.appspot.roble_nomans_debiruji.users.model.User}
     * @return the request
     */
    public Insert insert(com.appspot.roble_nomans_debiruji.users.model.User content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends UsersRequest<com.appspot.roble_nomans_debiruji.users.model.User> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.roble_nomans_debiruji.users.model.User content) {
        super(Users.this, "POST", REST_PATH, content, com.appspot.roble_nomans_debiruji.users.model.User.class);
      }
    ...
    public class List extends UsersRequest<com.appspot.roble_nomans_debiruji.users.model.UserCollection> {
       ...
       */
      protected List() {
        super(Users.this, "GET", REST_PATH, null, com.appspot.roble_nomans_debiruji.users.model.UserCollection.class);
      }
