...
public class SnakeView extends TileView {
    ...
    public Bundle saveState() {
        ...
        map.putInt("mDirection", Integer.valueOf(Direction));
        map.putInt("mNextDirection", Integer.valueOf(NextDirection));
        map.putLong("mMoveDelay", Long.valueOf(moveDelay));
    ...
    public void restoreState(Bundle icicle) {
        ...
        Direction = icicle.getInt("mDirection");
        NextDirection = icicle.getInt("mNextDirection");
        moveDelay = icicle.getLong("mMoveDelay");
